...
public class WarehouseRepository {
    ...
    static {
        ...
        try {
            ...
            reader = new BufferedReader(new FileReader("/Users/temporaryadmin/Documents/DCI/java-projects-individual-2_java-basics-6_functions-Parisamazinanian/SpringInitializr/WMS_Spring_Part1/data/stock.json"));
