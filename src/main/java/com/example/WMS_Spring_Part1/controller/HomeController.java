...
public class HomeController {
    ...
    //the below GetMapping method to return the items_list.html on the /listAllItems url call
    ...
    //Creating a controller to handle the "listItemByWarehouse/{warehouseId}" url.
    ...
    //add a GetMapping method to "/browseByCategory"
